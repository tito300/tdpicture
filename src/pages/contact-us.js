                ...
                <div id="contact-us__wrapper" className="page-wrapper">
                    ...
                    <div className="contactus__container">
                        ...
                        <form action="mailto:tarek.demachkie@gmail.com" method="post" className="contactus__form" onSubmit={this.handleSubmit}>
                            ...
                            <input type="text" name="subject" value={subject} placeholder=" Enter Subject . ." className="form-input subject"/>
                            <textarea type="text" name="body" value={body} placeholder=" Message . ." className="form-input body"/>
